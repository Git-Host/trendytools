...
<title>Samples for TrendyTools Business Website builder for DirectAdmin.</title>
...
<body>
<a href="business-website-builder-samples.php#" id="topScroll" rel="nofollow"></a>
<div id="mobilePage">
	<div id="mheader"> <a href="business-website-builder-samples.php#menu"></a> </div>
    <nav id="menu">
    		<ul>
              <li><a href="index.html" title="Home">Home</a></li>
              <li><a href="cpanel-html5-website-builders.php">Website Builders</a></li>
              <li class="Selected"><a href="business-website-builder-samples.php#">Samples</a></li>
    ...
    <div class="headerWrap">
       ...
       <div class="trtcontentWrap">
         <!--<div class="insideBgimg4"></div>-->
        	...
        	<h3 class="blubgcBig"> Sample Sites Created with  <span>Business Website Builder!</span> </h3>
            <div class="clientsites">
              <ul>
                <li><a href="http://builder.html5sitebuilder.com/builder/users/2003333/" target="_blank"><img src="trtools-themes/trtimages/business_sample_thumb01.jpg" alt="Sample Site"/></a><br />
                </li>
                <li><a href="http://builder.html5sitebuilder.com/builder/users/2001470/" target="_blank"><img src="trtools-themes/trtimages/business_sample_thumb02.jpg" alt="Sample Site"/></a><br />
                  <br />
                </li>
                <li><a href="http://builder.html5sitebuilder.com/builder/users/2001469/" target="_blank"><img src="trtools-themes/trtimages/business_sample_thumb03.jpg" alt="Sample Site"/></a></li>
              </ul>
            ...
            <div class="clientsites">
              <ul>
                <li><a href="http://builder.html5sitebuilder.com/builder/users/2001467/" target="_blank"><img src="trtools-themes/trtimages/business_sample_thumb04.jpg" alt="Sample Site"/></a><br />
                </li>
                <li><a href="http://builder.html5sitebuilder.com/builder/users/2001473/" target="_blank"><img src="trtools-themes/trtimages/business_sample_thumb05.jpg" alt="Sample Site"/></a><br />
                  <br />
                </li>
                <li><a href="http://builder.html5sitebuilder.com/builder/users/2001472/" target="_blank"><img src="trtools-themes/trtimages/business_sample_thumb06.jpg" alt="Sample Site"/></a></li>
              </ul>
            </div>
            <div class="lineBg"></div>
            <div class="clientsites">
              <ul>
                <li><a href="http://builder.html5sitebuilder.com/builder/users/2001475/" target="_blank"><img src="trtools-themes/trtimages/business_sample_thumb07.jpg" alt="Sample Site"/></a><br />
                </li>
                <li><a href="http://builder.html5sitebuilder.com/builder/users/2001536/" target="_blank"><img src="trtools-themes/trtimages/business_sample_thumb08.jpg" alt="Sample Site"/></a><br />
                  <br />
                </li>
                <li><a href="http://builder.html5sitebuilder.com/builder/users/2001538/" target="_blank"><img src="trtools-themes/trtimages/business_sample_thumb09.jpg" alt="Sample Site"/></a></li>
              </ul>
            </div>
...
<div class="hzlinePrc"></div>
	<div class="trtmainWrapin">
        ...
        <div class="insidepagettlWrap">
            ...
            <h3>Website builder for DirectAdmin – Sample Sites Created with TrendyTools Website Builders!</h3>
